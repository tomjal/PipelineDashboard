...
public class RepoServiceImpl implements RepoService{
     ...
     */
    @Transactional(readOnly = true)
    public Page<Repo> search(String query, Pageable pageable) {
        log.debug("Request to search for a page of Repos for query {}", query);
        return repoSearchRepository.search(queryStringQuery(query), pageable);
    }
}
