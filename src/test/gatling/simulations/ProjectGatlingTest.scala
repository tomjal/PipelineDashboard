...
class ProjectGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Project entity")
        ...
        .repeat(2) {
            ...
            .post("/api/projects")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "name":"SAMPLE_TEXT", "description":"SAMPLE_TEXT", "createdOn":"2020-01-01T00:00:00.000Z", "updatedOn":"2020-01-01T00:00:00.000Z", "twitter":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
